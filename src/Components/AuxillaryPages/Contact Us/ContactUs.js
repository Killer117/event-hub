...
import SocialMediaHandles from "../../Home/SocialMediaHandles";
...
function ContactUs() {
  ...
  return (
    <div className="contactUs d-flex flex-column">
      ...
      <div className={`d-flex ml-3 ${window.innerWidth< 700?"flex-column justify-content-center":"flex-row"} flex-row contactUs-details justify-content-between m-4`}>
        ...
        <div className="d-flex w-auto flex-row ">
          <ul className="p-3">
            ...
            <li>
              Nescii Lawns, NSUT, Azad Hind Fauz Marg, sec-3 Dwarka, New Delhi.
            </li>
          </ul>
        </div>
      </div>
